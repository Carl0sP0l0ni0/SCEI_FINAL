@extends('layouts.main', ['class' => 'off-canvas-sidebar', 'activePage' => 'login', 'title' => __('SCEI')])

@section('content')
<div class="container" style="height: auto;">
    <div class="row align-items-center">
        <div class="col-md-9 ml-auto mr-auto mb-3 text-center">
            <img style=" width:100px" src="https://upload.wikimedia.org/wikipedia/commons/f/fd/Escudo_de_Tingo_Mar%C3%ADa.png">
        </div>
