@extends('layouts.main', ['activePage' => 'users', 'titlePage' => 'Lista usuario'])
@section('content')
<div class="content">
      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header card-header-primary">
            <div class="card-title">Lista Usuarios</div>
            <p class="card-category">Lista detallada del usuario {{ $user->name }}</p>
          </div>
          <!--body-->
          <div class="card-body">
            @if (session('success'))
